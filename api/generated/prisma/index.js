...
const config = {
  "generator": {
    ...
    "output": {
      "value": "C:\\Users\\onenc\\OneDrive\\Desktop\\Creamaa\\api\\generated\\prisma",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "C:\\Users\\onenc\\OneDrive\\Desktop\\Creamaa\\api\\prisma\\schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": null,
  ...
  "inlineDatasources": {
    "db": {
      "url": {
        ...
        "value": "mongodb+srv://emma9:emma9@cluster0.o7zzj.mongodb.net/creamaDB?retryWrites=true&w=majority"
      }
    }
  },
  "inlineSchema": "// This is your Prisma schema file,\n// learn more about it in the docs: https://pris.ly/d/prisma-schema\n\n// Looking for ways to speed up your queries, or scale easily with your serverless or edge functions?\n// Try Prisma Accelerate: https://pris.ly/cli/accelerate-init\n\ngenerator client {\n  provider = \"prisma-client-js\"\n  output   = \"../generated/prisma\"\n}\n\ndatasource db {\n  provider = \"mongodb\"\n  url      = env(\"MONGODB_URL\")\n}\n\n// FIRST MODEL\n\nmodel User {\n  id        String   @id @default(auto()) @map(\"_id\") @db.ObjectId\n  email     String   @unique\n  username  String   @unique\n  password  String\n  avatar    String?\n  createdAt DateTime @default(now())\n}\n",
  "inlineSchemaHash": "2ab8a4fd896d0919211f5d625ab25a7ba2b127a7839bed8633134519883e7340",
  "copyEngine": true
}
